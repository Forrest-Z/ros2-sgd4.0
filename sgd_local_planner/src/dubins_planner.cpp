...
nav_msgs::msg::Path DubinsCurve::createPlan(
...
DubinsPath path;
// Starting position
    double q0[] = { start.pose.position.x, start.pose.position.y, q_start_.getAngle() };
// Final position (x, y, theta)
    double q1[] = { goal.pose.position.x, goal.pose.position.y, q_goal_.getAngle() };
